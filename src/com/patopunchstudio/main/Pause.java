...
public class Pause {
  ...
  public void render(Graphics g) {
    if (Game.gameState == "PAUSE") {
      ...
      Game.ui.stringRender(g, "Critical Chance: "+ critChance,new Font("arial", Font.BOLD, 16), -237, 150, Color.WHITE);
      Game.ui.stringRender(g, "Criticla Damage: "+ critDamage,new Font("arial", Font.BOLD, 16), -235, 200, Color.WHITE);
    }
  }
}
